...
1. Verificacion de entorno mamba/anaconda
   ...
   #+begin_example
	...
	libarchive version : libarchive 3.8.6 zlib/1.3.2 liblzma/5.8.2 bz2lib/1.0.8 liblz4/1.10.0 libzstd/1.5.7 liblzo2/2.10 openssl/3.5.5 libb2/bundled
	  envs directories : /home/sebaszun-epn/.local/share/mamba/envs
	     package cache : /home/sebaszun-epn/.local/share/mamba/pkgs
			     /home/sebaszun-epn/.mamba/pkgs
	       environment : iccd332 (active)
	      env location : /home/sebaszun-epn/.local/share/mamba/envs/iccd332
	 user config files : /home/sebaszun-epn/.mambarc
    populated config files : 
	  ...
	  base environment : /home/sebaszun-epn/.local/share/mamba
		  platform : linux-64
   #+end_example
...
Sebastián Josué Zúñiga Mendoza
#+ATTR_LATEX: :environment longtable :align |p{0.2\linewidth}|p{0.3\linewidth}|p{0.2\linewidth}|p{0.3\linewidth}|
| *Comando* | *Descripción*                                                                                           | *Comando* | *Descripción*                                                     |
|-----------+---------------------------------------------------------------------------------------------------------+-----------+-------------------------------------------------------------------|
| ~C-l~     | Cambiar la posición del texto ubicado alrededor del cursor, al centro, final y principio de la pantalla | ~C-f~     | Moverse un caracter hacia adelante                                |
| ~M-f~     | Moverse una palabra hacia adelante                                                                      | ~M-b~     | Moverse una palabra hacia atrás                                   |
| ~C-x 1~   | Expandir una ventana y borrar las demás                                                                 | ~M-k~     | Eliminar hasta el final de la oración actual                      |
| ~C-w~     | Eliminar toda una región seleccionada con C-<SPC>                                                       | ~C-x C-b~ | Mostrar la lista de buffers                                       |
| ~C-x 2~   | Dividir la pantalla en dos ventanas                                                                     | ~C-M-v~   | En ventanas divididas, desplazar la ventana  inferior hacia abajo |
|           |                                                                                                         |           |                                                                   |
...
**Comandos Fáciles**
1. **Sebastián Zúñiga:**
    ~C-x s~  C-x s runs the command save-some-buffers (found in global-map), which
is an interactive native-compiled Lisp function in ‘files.el’
2. **Estudiante B:** <Poner el comando>. <Pegar lo que dice el primer párrafo de la ayuda>
3. 
4. 

**Comandos Difíciles**
1. **Sebastián Zúñiga** ~C-M-v~.C-M-v runs the command scroll-other-window (found in global-map),
